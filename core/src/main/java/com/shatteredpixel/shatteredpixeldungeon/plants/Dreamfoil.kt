...
class Dreamfoil : Plant() {
    ...
    override fun activate() {
        ...
        if (ch != null) {
            if (ch is Mob)
                ...
                Buff.detach(ch, Bleeding::class.java)
                Buff.detach(ch, Drowsy::class.java)
                Buff.detach(ch, Slow::class.java)
                Buff.detach(ch, Vertigo::class.java)
            }
        }
    }
    ...
    class Seed : Plant.Seed() {
        init {
            ...
            plantClass = Dreamfoil::class.java
            alchemyClass = PotionOfPurity::class.java
        }
    }
}