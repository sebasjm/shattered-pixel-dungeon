...
object HighGrass {
    ...
    fun trample(level: Level, pos: Int, ch: Char?) {
        ...
        if (ch != null) {
            val naturalism = ch.buff<SandalsOfNature.Naturalism>(SandalsOfNature.Naturalism::class.java)
            if (naturalism != null) {
        ...
        if (ch is Hero) {
            ...
            //Camouflage
            if (hero.belongings.armor != null && hero.belongings.armor!!.hasGlyph(Camouflage::class.java)) {
                Buff.affect<Camouflage.Camo>(hero, Camouflage.Camo::class.java)!!.set(3 + hero.belongings.armor!!.level())
                leaves += 4
            }
        }
