...
object FroyoGLES20Fix {

    init {
        System.loadLibrary("FroyoGLES20Fix")
    }

    external fun glVertexAttribPointer(index: Int, size: Int, type: Int, normalized: Boolean, stride: Int, offset: Int)

    external fun glDrawElements(mode: Int, count: Int, type: Int, offset: Int)
